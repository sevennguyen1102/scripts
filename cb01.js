...
document.addEventListener('DOMContentLoaded', function () {
    (function () {
        ...
        if (urlParams.has('tid')) {
            ...
            var sanitizedTid = sanitizeParam(tid);
            urlParams.set('tid', sanitizedTid);
        }

        if (urlParams.has('gclid')) {
            var gclid = urlParams.get('gclid');
            var sanitizedgclid = sanitizeParam(gclid);
            urlParams.set('extclid', sanitizedgclid);
        ...
        var trackingId = urlParams.get('extclid') || urlParams.get('gbraid') || urlParams.get('wbraid') || urlParams.get('msclkid') || urlParams.get('fbclid');
